...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Set-2024 às 05:53
...
(1, 4, 2, '2024-09-28', '2025-07-25'),
(2, 2, 2, '2024-09-28', '2025-09-27'),
(3, 2, 3, '2024-08-26', '2024-09-25');
...
(1, 'Vitor Sianavas', 'vpsianavas@gmail.com', 1, 'FIN'),
(2, 'Carlos Augusto', 'ca@gmail.com', 2, 'CCC'),
(3, 'Carolina', 'Carol@yahoo.com', 3, 'FIN'),
(4, 'Alexios', 'asianavas@', 1, 'VEN'),
(5, 'ADRIANO', 'aaaaaa', 3, 'FIN');
...
ALTER TABLE `ocorrencias`
  ...
  ADD KEY `ocorrencias_ibfk_3` (`evento`);
...
--
-- AUTO_INCREMENT de tabela `oceanos`
--
ALTER TABLE `oceanos`
...
--
ALTER TABLE `tipousuario`
  MODIFY `id_tipousr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
